...
var allConfigKeys = []string{
	...
	"SELECTED_SERVER_ID", "EXPLO_SYSTEM", "SYSTEM_URL", "API_KEY", "LIBRARY_NAME",
	"SYSTEM_USERNAME", "SYSTEM_PASSWORD", "PLAYLIST_DIR", "SLEEP", "PUBLIC_PLAYLIST",
	"ADMIN_API_KEY", "ADMIN_SYSTEM_USERNAME", "ADMIN_SYSTEM_PASSWORD",
	"DOWNLOAD_DIR", "PATH_TEMPLATE", "PLAYLISTNAME_FORMAT",
	"USE_SUBDIRECTORY", "KEEP_PERMISSIONS",
	"DOWNLOAD_SERVICES", "YOUTUBE_API_KEY", "TRACK_EXTENSION", "FILTER_LIST",
	"SLSKD_URL", "SLSKD_API_KEY", "SLSKD_DIR",
	"WIZARD_COMPLETE", "MIGRATE_DOWNLOADS", "SINGLE_ARTIST",
	"ENRICH_TRACK_METADATA", "OVERWRITE_METADATA", "EXTENSIONS",
}
